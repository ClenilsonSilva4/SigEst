package AplicaçãoEstudantil.main;

import java.util.Scanner;
import AplicaçãoEstudantil.entities.Recurso;
import AplicaçãoEstudantil.exception.*;
import AplicaçãoEstudantil.service.login.LoginService;
import AplicaçãoEstudantil.service.login.LoginServiceInterface;
import AplicaçãoEstudantil.service.usuario.estudante.EstudanteService;
import AplicaçãoEstudantil.service.usuario.estudante.EstudanteServiceInterface;
import AplicaçãoEstudantil.service.usuario.gestor.GestorService;
import AplicaçãoEstudantil.service.usuario.gestor.GestorServiceInterface;
import AplicaçãoEstudantil.service.usuario.professor.ProfessorService;
import AplicaçãoEstudantil.service.usuario.professor.ProfessorServiceInterface;
import AplicaçãoEstudantil.view.MainView;
